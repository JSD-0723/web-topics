...
function TopicDetails() {
    ...
    const fetchData = async () => {
        const response = await fetch("https://tap-web-1.herokuapp.com/topics/details/3")
                    ...
                    <div class="course-topics-sub-container">
                        ...
                        <ul class="course-topic">
                            <li>
                                ...
                                ></ion-icon>{topic.subtopics[0]}
                            </li>
                            <li>
                                <ion-icon
                                    name="checkmark-circle-outline"

                                ></ion-icon>{topic.subtopics[1]}
                            </li>
                            <li>
                                <ion-icon
                                    name="checkmark-circle-outline"

                                ></ion-icon>{topic.subtopics[2]}
                            </li>
                            <li>
                                <ion-icon
                                    name="checkmark-circle-outline"
                                ></ion-icon>{topic.subtopics[3]}
                            </li>
                            <li>
                                <ion-icon
                                    name="checkmark-circle-outline"

                                ></ion-icon>{topic.subtopics[4]}
                            </li>
                            <li>
                                <ion-icon
                                    name="checkmark-circle-outline"

                                ></ion-icon>{topic.subtopics[5]}
                            </li>
                        </ul>
                    </div>
                </div>
